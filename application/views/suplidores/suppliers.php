...
<div class="container-fluid">
	<div class="box">
		<div class="action-button">
			...
			<a href="<?= base_url('suplidores/view_all') ?>" class="btn btn-warning">Ver todos ></a>
		...
		<?php if($suplidores): ?>
			<table class="table" id="suplidores" style="border-collapse: collapse !important;">
				<thead>
					<tr>
						<th colspan="5" style="font-size: 24px; background-color: chartreuse;">Suplidores</th>
					</tr>
					<tr>
					...
					<?php foreach ($suplidores as $suplidor): ?>
						<tr>
							...
							<td>
								...
								<a onclick="return confirm('Estás seguro?')" href="<?= base_url('suplidores/delete/').$suplidor->id ?>" class="delete-button"><i class="far fa-trash-alt"></i></a>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
